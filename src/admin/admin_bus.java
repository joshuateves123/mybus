...
public class admin_bus extends javax.swing.JFrame {
    ...
    public void displayTable(){
        try{
            ...
            String query = "SELECT * FROM tbl_bus WHERE b_status != 'Archived'";
    ...
    private void initComponents() {
        ...
        jPanel8.setBackground(new java.awt.Color(97, 103, 122));
        ...
        jPanel12.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 630, 50));
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if(rowid != -1){
            admin_busEdit edit = new admin_busEdit();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        admin_busAdd add = new admin_busAdd();
        add.setVisible(true);
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jPanel13MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel13MouseClicked
        String query = searchbar.getText();
        String searchQuery = "SELECT * FROM tbl_bus WHERE b_id LIKE '%" + query + "%' OR b_name LIKE '%" + query + "%' OR b_model LIKE '%" + query + "%' OR b_capacity LIKE '%"
